...
{       struct Node
 ...
 //                               cout<<"#"<<root->data<<"#";
        ...
        void convertToSumArray(Node *t)
        {       if(t==NULL||(t->left==NULL&&t->right==NULL))return;
                convertToSumArray(t->left);
                convertToSumArray(t->right);
                int a=0,b=0,diff;
                if(t->left)a=t->left->data;
                if(t->right)b=t->right->data;
                diff=a+b- t->data;
                if(diff>=0)
                t->data=a+b;
                else 
        ...
        void increment(Node *t,int diff)
      ...
      public:
        ...
        void convertToSumArray()
        {       convertToSumArray(root);
        }
};
