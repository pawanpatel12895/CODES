...
class Tree
{
        ...
        Node *deleteOutside(Node *t,int ,int);
       ...
       public:
        ...
        void deleteOutside(int l,int r)
        {       root = deleteOutside(root,l,r);       }
};

Tree::Node *Tree::deleteOutside(Node *t,int l,int r)
{       if(t==NULL)return NULL;
        ...
        {       delAll(t->left);
                ...
                free(t);
                t=x;
                t = deleteOutside(t,l,r);
        }
        else 
                t->left = deleteOutside(t->left,l,r);
        if(t->data > r)
        {       delAll(t->right);
                t->right = NULL;
                Node *x = t->left;
                ...
                t->right = deleteOutside(t->right,l,r);       
        return t;
}
int main(int argc, char *argv[])
{
        int A[]={1,3,7,9,4,2,4,5,6,7,4,8,53,5,7657,35,2,7575,24};
