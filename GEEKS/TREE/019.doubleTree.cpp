...
class Tree
{
       ...
       public:
        ...
        void createDouble()
        {       root=createDouble(root);}
};
Tree::Node *Tree::createDouble(Node* t)
{       if(t==NULL)return NULL;
        t->left=createDouble(t->left);
        t->right=createDouble(t->right);
        Node *u=getNode(t->data);
        u->left=t->left;
        t->left=u;
        return t;
}
