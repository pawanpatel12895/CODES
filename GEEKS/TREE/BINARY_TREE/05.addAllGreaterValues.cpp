...
class Tree
{
        ...
        void AddAllGreaterValues(Node *t);
       ...
       public:
        ...
        void AddAllGreaterValues()
        {       AddAllGreaterValues(root);
        
        }
};
void Tree::AddAllGreaterValues(Node *t)
{       if(t==NULL)return;
        static int sum = 0;
        AddAllGreaterValues(t->right);
        sum = t->data = sum + t->data;
        AddAllGreaterValues(t->left); 
}
